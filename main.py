...
for t in range(run_times):
    ...
    optimizer = PSO(fitness=benchmark.Sphere,
    ...
    optimizer = PSO(fitness=benchmark.Rastrigin,
    ...
    optimizer = PSO(fitness=benchmark.Ackley,
    ...
    optimizer = PSO(fitness=benchmark.Griewank,
    ...
    optimizer = PSO(fitness=benchmark.Schwefel_P222,
    ...
    optimizer = PSO(fitness=benchmark.Rosenbrock,
    ...
    optimizer = PSO(fitness=benchmark.Sehwwefel_P221,
    ...
    optimizer = PSO(fitness=benchmark.Quartic,
    ...
    optimizer = PSO(fitness=benchmark.Schwefel_P12,
    ...
    optimizer = PSO(fitness=benchmark.Penalized1,
    ...
    optimizer = PSO(fitness=benchmark.Penalized2,
    ...
    optimizer = PSO(fitness=benchmark.Schwefel_226,
    ...
    optimizer = PSO(fitness=benchmark.Step,
    ...
    optimizer = PSO(fitness=benchmark.Kowalik,
    ...
    optimizer = PSO(fitness=benchmark.ShekelFoxholes,
    ...
    optimizer = PSO(fitness=benchmark.GoldsteinPrice,
    ...
    optimizer = PSO(fitness=benchmark.Branin,
    ...
    optimizer = PSO(fitness=benchmark.Hartmann3,
    ...
    ub = bound_X.Shekel()[1]*np.ones(dimension.Shekel())
    lb = bound_X.Shekel()[0]*np.ones(dimension.Shekel())
    optimizer = PSO(fitness=benchmark.Shekel,
                    D=dimension.Shekel(), P=P, G=G, ub=ub, lb=lb)
    st = time.time()
    optimizer.opt()
    ed = time.time()
    ...
    optimizer = PSO(fitness=benchmark.SixHumpCamelBack,
    ...
    optimizer = PSO(fitness=benchmark.Hartmann6,
    ...
    optimizer = PSO(fitness=benchmark.Zakharov,
    ...
    optimizer = PSO(fitness=benchmark.SumSquares,
    ...
    optimizer = PSO(fitness=benchmark.Alpine,
    ...
    optimizer = PSO(fitness=benchmark.Michalewicz,
    ...
    optimizer = PSO(fitness=benchmark.Exponential,
    ...
    optimizer = PSO(fitness=benchmark.Schaffer,
    ...
    optimizer = PSO(fitness=benchmark.BentCigar,
    ...
    optimizer = PSO(fitness=benchmark.Bohachevsky1,
    ...
    optimizer = PSO(fitness=benchmark.Elliptic,
    ...
    optimizer = PSO(fitness=benchmark.DropWave,
    ...
    optimizer = PSO(fitness=benchmark.CosineMixture,
    ...
    optimizer = PSO(fitness=benchmark.Ellipsoidal,
    ...
    optimizer = PSO(fitness=benchmark.LevyandMontalvo1,
